...
- After analysis of the residuals of these models, it seemed logical to treat the models as what could possibly be a quadratic model rather than simple linear regression models. So we ran the code:
...
Using the stepAIC function in our methods gives us the best possible model given the variables input into the regression models. Because we have our best model, we can move on to looking at the residuals and P values. 
